...
public class UpdateServiceStsToBarred extends Helper_delete{

    public static Response updateSrvStsToBar_Pre(String endPoint, Map<String,String> headers) throws IOException {
        ...
        RequestSpecification requestSpecification= RestAssured.given().log().all().
                ...
                body(updateSrvStatus_Pre("MSISDN", MSISDN,
                        "ReasonCode", BaseClass.excel.
                                getupdateSrvSts_Detail("updateSrvSts_Pre", 2, 0),
                        "SrvState", (int)BaseClass.excel.
                                getupdateSrvSts_NumericDetail("updateSrvSts_Pre", 2, 1),
                        "RecFlag", (int)BaseClass.excel.
                                getupdateSrvSts_NumericDetail("updateSrvSts_Pre", 2, 2)));
        ...
        File targetFileForString = new File("./ResponseFiles/api_data"+ "updateSrvStatus117_Pre"
