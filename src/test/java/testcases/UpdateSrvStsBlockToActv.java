...
public class UpdateSrvStsBlockToActv extends Helper_delete{

    public static Response updateSrvStsToReActv_Pre(String endPoint, Map<String,String> headers) throws IOException {
        ...
        RequestSpecification requestSpecification= RestAssured.given().log().all().
                ...
                body(updateSrvStatus_Pre("MSISDN", MSISDN,
                        "ReasonCode", BaseClass.excel.
                                getupdateSrvSts_Detail("updateSrvSts_Pre", 5, 0),
                        "SrvState", (int)BaseClass.excel.
                                getupdateSrvSts_NumericDetail("updateSrvSts_Pre", 5, 1),
                        "RecFlag", (int)BaseClass.excel.
                                getupdateSrvSts_NumericDetail("updateSrvSts_Pre", 5, 2)));
        ...
        File targetFileForString = new File("./ResponseFiles/api_data"+ "updateSrvStatus120To116_Pre"
