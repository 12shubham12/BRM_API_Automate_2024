...
public class UpdateServiceStsToSuspnd extends Helper_delete{

    public static Response updateSrvStsToSuspnd_Pre(String endPoint, Map<String,String> headers) throws IOException {
        ...
        RequestSpecification requestSpecification= RestAssured.given().log().all().
                ...
                body(updateSrvStatus_Pre("MSISDN", MSISDN,
                        "ReasonCode", BaseClass.excel.
                                getupdateSrvSts_Detail("updateSrvSts_Pre", 3, 0),
                        "SrvState", (int)BaseClass.excel.
                                getupdateSrvSts_NumericDetail("updateSrvSts_Pre", 3, 1),
                        "RecFlag", (int)BaseClass.excel.
                                getupdateSrvSts_NumericDetail("updateSrvSts_Pre", 3, 2)));
        ...
        File targetFileForString = new File("./ResponseFiles/api_data"+ "updateSrvStatus118_Pre"
