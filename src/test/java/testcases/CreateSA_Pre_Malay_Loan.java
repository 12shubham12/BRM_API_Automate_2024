...
public class CreateSA_Pre_Malay_Loan extends Helper_delete{

    public static Response createPreSA_Maly_Loan(String endPoint,Map<String,String> headers) throws IOException {
        RequestSpecification requestSpecification =
         RestAssured.given().log().all().
                ...
                body(readPayload_Pre_SA_Loan("PRE_SA", BaseClass.excel.
                ...
                File targetFileForString = new File("./ResponseFiles/api_data"+"CreateSA_Pre_Malay_Loan"
