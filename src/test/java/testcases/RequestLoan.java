...
public class RequestLoan extends Helper_delete{

    public static Response requestLoan_Pre(String endPoint, Map<String,String> headers) throws IOException {

        BaseClass.jdbcConnection(CUSID_LOAN);
        ...
        RequestSpecification requestSpecification= RestAssured.given().log().all().
                ...
                body(requestLoan_Pre("MSISDN", MSISDN_Loan,
                        "LORID", BaseClass.excel.
                                getreqLoan_Detail("Loan", 1, 0),
                        "LAMT", (int)BaseClass.excel.
                                getreqLoan_NumericDetail("Loan", 1, 1)));

                Response response = requestSpecification.post("/recharge/requestLoan");
        ...
        File targetFileForString = new File("./ResponseFiles/api_data"+ "reqLoan_Pre"
